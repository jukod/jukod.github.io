...
At the end,
the team with [most solved problems][25sb] wins.
It's quite fun!  :-)
...
Karlstad University
and
our very own __Jönköping University__.

JU has participated since 2022,
and has got improved results and participation each year:

| NCPC Edition      | #-solved&nbsp;ps. | 🇸🇪-rank     | 🇸🇪%   | rank            | %           |
| ----------------- | ----------------- | ------------- | ------- | --------------- | ----------- |
...
we have plans to do this again in the upcoming years.
...
The department of computing has reserved some time of two teachers
for organizing the competition itself
as well as
practice sessions for students throughout the year.
...
and qualifying to the next stage: the EUC, the European finals.

NCPC hosting costs are mainly food (light lunch)
and minor costs in office material.
NWERC costs are mainly transport
and accomodation: flight, train, bus and hotel.
